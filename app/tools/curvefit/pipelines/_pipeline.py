...
from app.tools.curvefit.pv.forecaster import Forecaster
from app.tools.curvefit.pv.pv import PVModel
from app.tools.curvefit.diagnostics.plot_diagnostics import plot_fits
...
class ModelPipeline:
    ...
    def __init__(self, all_data, col_t, col_obs, col_group,
        ...
        Args:
            ...
            fun: (callable) the space to fit in, one of app.tools.curvefit.functions
            predict_space: (callable) the space to do predictive validity in, one of app.tools.curvefit.functions
            obs_se_func: (optional) function to get observation standard error from col_t

        Attributes:
            self.pv: (app.tools.curvefit.pv.PVModel) predictive validity model
            self.forecaster: (app.tools.curvefit.forecaster.Forecaster) residual forecasting tool
    ...
    def predict(self, times, predict_space, predict_group):
        ...
        Args:
            ...
            predict_space: (callable) app.tools.curvefit.functions function to predict in that space
    ...
    def plot_results(self, prediction_times, sharex=True, sharey=False, draw_space=None,
        ...
        Args:
            ...
            draw_space: (callable) app.tools.curvefit.functions what space to plot draws in
