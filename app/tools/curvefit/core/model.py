...
from app.tools.curvefit.core import utils

from app.tools.curvefit.core.utils import get_initial_params
from app.tools.curvefit.core.utils import compute_starting_params
from app.tools.curvefit.core.functions import normal_loss
from app.tools.curvefit.core.effects2params import effects2params
from app.tools.curvefit.core.objective_fun import objective_fun
    ...
    def predict(self, t, group_name='all', prediction_functional_form=None):
        ...
        Args:
            ...
            prediction_functional_form (function):
                One of the functions from app.tools.curvefit.functions
