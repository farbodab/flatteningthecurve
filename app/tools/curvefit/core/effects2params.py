...
def unzip_x(x, num_groups, num_fe) :
    ...
    ## Syntax
    `fe, re = app.tools.curvefit.core.effects2params.unzip_x(x, num_groups, num_fe)`
...
def effects2params(x, group_sizes, covs, link_fun, var_link_fun, expand=True) :
    ...
    ## Syntax
    `params = app.tools.curvefit.core.effects2params.effects2params(
    ...
    fe_idx     = app.tools.curvefit.core.utils.sizes_to_indices(fe_sizes)
    #
    # asserts
