import numpy as np
import pandas as pd
from app.tools.curvefit.diagnostics.plot_diagnostics import plot_residuals, plot_predictions, plot_residuals_1d, plot_es
from app.tools.curvefit.core.utils import neighbor_mean_std
...
class PVGroup:
    def __init__(self, data, col_t, col_obs, col_grp, col_obs_compare,
        ...
        Args:
            ...
            predict_space: a function from app.tools.curvefit.model that gives the prediction space to calculate PV in
